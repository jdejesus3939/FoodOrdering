...
import info.jproject.opensource.foodordering.library.HTMLParser;
...
public class UnivCenterMainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    try {
	        if (jsonhist.getString("uc_success") != null) {
	            ...
	            if(Integer.parseInt(uchist) == 0){
	            	...
	            	uctvhistory = uctvhistory + "You have not made any purchase on regular menu with this vendor\n";
	            }
	        ...
	        if (jsonhist.getString("uc_cl_success") != null) {
	            ...
	            if(Integer.parseInt(ucclhist) == 0){
	            	...
	            	uctvhistory = uctvhistory + "You have not made any purchase on classics menu with this vendor\n";
	            }
		...
		/*
		//commented out as for now the uc is not active
