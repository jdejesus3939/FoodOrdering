	...
	public void onCreate(Bundle savedInstanceState) {
		...
		*/
		...
		if (checkID.equals(STARBUCK))
		{
			...
			{
				drinks = drinks + starbucksStringCheckout[6] + " ($ " + starbucksPriceCheckout[6] + ")" + "\n";
				subtotal = subtotal + starbucksPriceCheckout[6];
			}
			if (starbucksStringCheckout[7].equals("No"))
				drinks = drinks;
			else
			{
				drinks = drinks + starbucksStringCheckout[7] + " ($ " + starbucksPriceCheckout[7] + ")" + "\n";
			...
			{
				drinks = drinks + starbucksStringCheckout[8] + " ($ " + starbucksPriceCheckout[8] + ")" + "\n";
				subtotal = subtotal + starbucksPriceCheckout[8];
			}
			if (starbucksStringCheckout[9].equals("No"))
				drinks = drinks;
			else
			{
				drinks = drinks + starbucksStringCheckout[9] + " ($ " + starbucksPriceCheckout[9] + ")" + "\n";
			...
			{
				drinks = drinks + starbucksStringCheckout[10] + " ($ " + starbucksPriceCheckout[10] + ")" + "\n";
				subtotal = subtotal + starbucksPriceCheckout[10];
			}
			if (starbucksStringCheckout[11].equals("No"))
				drinks = drinks;
			else
			{
				drinks = drinks + starbucksStringCheckout[11] + " ($ " + starbucksPriceCheckout[11] + ")" + "\n";
		...
		*/
		...
		if (checkID.equals(SUBWAY))
		{
		    ...
		    if(subwayStringCheckout[5].equals("Yes (with chips and drink)"))
			...
			tvCheckout2.setText("with flavor:\n" + subwayStringCheckout[2] + "\n\n" +
					...
					"is it meal?\n" + subwayStringCheckout[5] + " ($ " + subwayPriceCheckout[2] + ")" + "\n");
			
			String vegies = "with vegetables:\n";
			if (subwayStringCheckout[6].equals("No"))
				vegies = vegies;
			else
				vegies = vegies + subwayStringCheckout[6] + "\n";
			if (subwayStringCheckout[7].equals("No"))
				vegies = vegies;
			else
				vegies = vegies + subwayStringCheckout[7] + "\n";
