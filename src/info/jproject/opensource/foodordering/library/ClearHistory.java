...
public class ClearHistory {
	 ...
	 */
	public JSONObject clearEinsteinBros(String ID_KEY, String PHPSESSID,
			Context context) {
		...
		JSONObject json = jsonParser.getJSONFromUrl(
				AppConstants.ClearHistoryURL, PHPSESSID, params);
		// return json
	 ...
	 * Function checkout process
	 */
	public JSONObject clearSubway(String ID_KEY, String PHPSESSID,
			Context context) {
		DatabaseHandler db = DatabaseHandler.getDatabaseHandler(context);
		name = db.getUserName();
		anumber = db.getAnumber();
	 ...
	 * Function checkout process
	 */
	public JSONObject clearSimplyToGo(String ID_KEY, String PHPSESSID,
			Context context) {
		DatabaseHandler db = DatabaseHandler.getDatabaseHandler(context);
		name = db.getUserName();
		anumber = db.getAnumber();
	 ...
	 * Function checkout process
	 */
	public JSONObject clearStarbucks(String ID_KEY, String PHPSESSID,
			Context context) {
		DatabaseHandler db = DatabaseHandler.getDatabaseHandler(context);
		name = db.getUserName();
		anumber = db.getAnumber();
	 ...
	 * Function checkout process
	 */
	public JSONObject clearUltimateBaja(String ID_KEY, String PHPSESSID,
			Context context) {
		DatabaseHandler db = DatabaseHandler.getDatabaseHandler(context);
		name = db.getUserName();
		anumber = db.getAnumber();
	 ...
	 * Function checkout process
	 */
	public JSONObject clearUnivCenter(String ID_KEY, String PHPSESSID,
			Context context) {
		DatabaseHandler db = DatabaseHandler.getDatabaseHandler(context);
		name = db.getUserName();
		anumber = db.getAnumber();
